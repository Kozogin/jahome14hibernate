...
//	@PrimaryKeyJoinColumn
	...
	public FileMultipart(String id, String fileName, String fileType, byte[] data, Student student) {
	this.id = id;
	...
	public String toString() {
		return "FileMultipart [id=" + id + ", fileName=" + fileName + ", fileType=" + fileType + "]";
	}
